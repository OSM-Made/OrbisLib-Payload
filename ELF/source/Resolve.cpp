...
void resolve(uint64_t kernbase) {
	...
	RESOLVE(vprintf, kernbase, __vprintf);
	...
	RESOLVE(strcmp, kernbase, __strcmp);
	RESOLVE(strcpy, kernbase, __strcpy);
	...
	RESOLVE(mtx_lock, kernbase, __mtx_lock);
	RESOLVE(mtx_unlock, kernbase, __mtx_unlock);
	RESOLVE(mtx_destroy, kernbase, __mtx_destroy);
	...
	RESOLVE(kern_Delay, kernbase, __kern_Delay);*/
}
