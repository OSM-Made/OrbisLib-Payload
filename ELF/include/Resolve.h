...
#define __mtx_lock                              0x401C10
#define __mtx_unlock                            0x401C50
#define __mtx_destroy                           0x4027F0 
...
#define __kern_getsockname                      0x31BAA0
...
/*void *M_TEMP;
const sbl_map_list_entry **sbl_driver_mapped_pages;
const uint8_t *mini_syscore_self_binary;
sbl_key_rbtree_entry **sbl_keymgr_key_rbtree;
void *fpu_kern_ctx;
...
int (*kthread_add)(void (*func)(void *), void *arg, proc *procp, thread **newtdpp, int flags, int pages, const char *fmt, ...);
...
int (*proc_rwmem)(struct proc *p, uio *uio);
...
int	(*fill_regs)(struct thread *td, reg *rg);
int	(*set_regs)(struct thread *td, reg *rg);
